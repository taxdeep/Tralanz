...
public sealed class JournalEntryEditorState
{
    ...
    private JournalEntryEditorState(
        ...
        IReadOnlyList<JournalEntryCurrencyOption> currencyOptions,
    ...
    public IReadOnlyList<JournalEntryCurrencyOption> CurrencyOptions { get; }
    ...
    public static JournalEntryEditorState CreateDarkModeDemo()
    {
        var currencyOptions = new[]
        {
            ...
            new JournalEntryCurrencyOption { Code = "CAD", Label = "Canadian Dollar", Flag = "CAD", DefaultRateToBase = 1m },
    ...
    {
        var option = CurrencyOptions.FirstOrDefault(x => x.Code == currencyCode);
        if (option is null)
        {
            return;
        }
