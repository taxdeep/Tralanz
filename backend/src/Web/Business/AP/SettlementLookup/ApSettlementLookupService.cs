...
public sealed class ApSettlementLookupService(PostgreSqlConnectionFactory connections) : IApSettlementLookupService
{
    public async Task<IReadOnlyList<(Guid Id, string DisplayLabel, string CurrencyCode)>> ListVendorsAsync(
        Guid companyId,
