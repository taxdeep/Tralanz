...
public sealed class DefaultPostingEngine : IPostingEngine
{
    ...
    private static Citus.Accounting.Domain.Currencies.FxSnapshotRef? TryGetEmbeddedFxSnapshot(IPostingDocument document) =>
        document switch
        {
            ...
            BillReversePostingDocument billReverse => billReverse.FxSnapshot,
            ...
            BankDepositDocument bankDeposit => bankDeposit.FxSnapshot,
            TaxReturnDocument taxReturn => taxReturn.FxSnapshot,
