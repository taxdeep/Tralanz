# Deprecated Authority Redirect

This file is deprecated. Use [CITUS_PRODUCT_ENGINEERING_AUTHORITY.md](./CITUS_PRODUCT_ENGINEERING_AUTHORITY.md) as the active top-priority product and engineering authority for Citus.
